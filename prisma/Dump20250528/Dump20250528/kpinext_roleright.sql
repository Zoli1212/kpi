...
CREATE TABLE `roleright` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `RoleRight_rightId_key` (`rightId`),
  CONSTRAINT `RoleRight_rightId_fkey` FOREIGN KEY (`rightId`) REFERENCES `right` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
