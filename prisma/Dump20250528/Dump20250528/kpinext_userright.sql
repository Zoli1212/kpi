...
CREATE TABLE `userright` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UserRight_userId_rightId_key` (`userId`,`rightId`),
  KEY `UserRight_rightId_fkey` (`rightId`),
  CONSTRAINT `UserRight_rightId_fkey` FOREIGN KEY (`rightId`) REFERENCES `right` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `UserRight_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
